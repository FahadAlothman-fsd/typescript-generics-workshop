...
const translate = <
  ...
  keyType extends keyof TTranslation,
  paramsKeys = GetParamKeysAsUnion<TTranslation[keyType]>
>(
  translations: TTranslation,
  key: keyType,
  ...args: paramsKeys extends string
    ? [dynamicArgs: Record<paramsKeys, string>]
    : []
) => {
